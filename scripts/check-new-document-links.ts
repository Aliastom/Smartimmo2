...
async function checkNewDocumentLinks() {
  const documentId = 'cmgxpp3es0007dg3940mf8zzu'; // Le nouveau document
  ...
  console.log('Liens pour le nouveau document', documentId, ':', links.length);
