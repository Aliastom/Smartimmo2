...
/**
 * Script pour vérifier le dernier upload depuis bien/baux
 */
...
async function checkLatestUploadBienBaux() {
  console.log('🔍 Vérification du dernier upload depuis bien/baux\n');
  ...
  try {
    ...
    console.log('   Vérifiez que le serveur Next.js est bien redémarré après la correction.');
