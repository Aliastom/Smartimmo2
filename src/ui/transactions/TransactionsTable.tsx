...
import { getTransactionDisplay } from '../../utils/transaction-display';
                    ...
                    <div className="flex items-center justify-end space-x-2">
                      {onEdit && (
                        <button
                          ...
                          className="text-primary hover:text-blue-800 transition-colors relative"
                          title="Éditer"
                        >
                          <Edit size={16} />
                          {hasAttachments && (
                            <span className="absolute -top-1 -right-1 flex items-center justify-center w-4 h-4 text-[10px] font-bold text-violet-700 bg-violet-100 rounded-full">
                              {attachmentCount}
                            </span>
                          )}
                        </button>
