...
import { Edit, Copy, Trash2, Download, FileText, Building2, Calendar, Euro, Percent, Clock, ChevronDown } from 'lucide-react';
      ...
      <div className="p-4">
        <div className="space-y-4">
              <section className="border-b pb-4">
                <p className="text-sm text-gray-600">{loan.label}</p>
              </section>
              {/* Header cockpit */}
