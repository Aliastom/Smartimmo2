...
export function ConfirmDeleteEcheanceModal({
  ...
  return (
    <Modal
      ...
      title={actionType === 'delete' ? 'Supprimer cette échéance ?' : 'Désactiver cette échéance ?'}
      size="md"
        ...
        {echeanceLabel && (
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Échéance : <span className="font-medium text-gray-900">{echeanceLabel}</span>
            </p>
          </div>
        )}
          ...
          <label className="flex items-start p-3 border-2 rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
            ...
            <div className="ml-3 flex-1">
              <span className="text-sm font-medium text-gray-900">
                Désactiver l'échéance
              </span>
              <p className="text-xs text-gray-500 mt-1">
                L'échéance sera désactivée mais conservée dans la base de données
              </p>
            </div>
          </label>
          ...
          <label className="flex items-start p-3 border-2 rounded-lg cursor-pointer transition-colors hover:bg-gray-50">
            ...
            <div className="ml-3 flex-1">
              ...
              <p className="text-xs text-red-600 mt-1">
                <strong>Action irréversible</strong> : l'échéance sera définitivement supprimée
              </p>
            </div>
          </label>
        </div>
