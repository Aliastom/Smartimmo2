  ...
  const cards = [
    {
      ...
      trendValue: kpis.deltaSommesEncaisses,
      trendLabel: `${kpis.deltaSommesEncaisses >= 0 ? '+' : ''}${formatCurrencyWithDecimals(kpis.deltaSommesEncaisses)}`,
      trendDirection: getTrendDirection(kpis.deltaSommesEncaisses),
    },
    {
      id: 'depenses',
      ...
      color: 'red' as const,
      trendValue: kpis.deltaDepensesRealisees,
      trendLabel: `${kpis.deltaDepensesRealisees >= 0 ? '+' : ''}${formatCurrencyWithDecimals(kpis.deltaDepensesRealisees)}`,
      trendDirection: getTrendDirection(kpis.deltaDepensesRealisees),
    },
    {
      id: 'cashflow',
