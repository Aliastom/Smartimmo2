...
import { Plus, Edit, Trash2, Copy, ChevronLeft, ChevronRight, CheckCircle } from 'lucide-react';
...
export default function EcheancesPage() {
  ...
  // Données de référence (biens, baux)
  ...
  // Charger les données de référence (biens, baux)
  useEffect(() => {
    const loadReferenceData = async () => {
      try {
        ...
        const leasesArray = leasesData.items || leasesData.data || [];
        setLeases(
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      // Si activeKpiFilter === 'total' ou null, pas de filtre supplémentaire
  ...
  }, [filters, pagination.page, pagination.limit, activeKpiFilter]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <SectionTitle
        ...
        description="Gérez vos charges et revenus périodiques"
        actions={
        ...
        <div className="bg-white rounded-xl border border-gray-200">
          ...
          <div className="p-4 border-b border-gray-200">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-lg font-semibold text-gray-900">Échéances récurrentes</h3>
                        ...
                        <Switch
                          ...
                          onCheckedChange={async (checked) => {
                            try {
                              ...
                              if (response.ok) {
                                // Invalider toutes les queries React Query pour rafraîchir
                                queryClient.invalidateQueries({ queryKey: ['echeances-kpis'] });
                                queryClient.invalidateQueries({ queryKey: ['echeances-charts'] });
                                queryClient.invalidateQueries({ queryKey: ['dashboard-patrimoine'] });
                                queryClient.invalidateQueries({ queryKey: ['patrimoine'] });
