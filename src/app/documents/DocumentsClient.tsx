...
export default function DocumentsClient() {
  ...
  // Charger les KPI avec les hooks
  ...
  // Charger les graphiques avec les hooks
  ...
  }, [filters, pagination.offset, pagination.limit, activeKpiFilter]);
  ...
  }, [openModalWithFileSelection, loadData]);
  ...
  // Recherche directe (pas besoin de handleSearch car onChange met à jour directement)
  ...
  return (
    <div className="space-y-6">
      ...
      <SectionTitle
        title="Documents"
        description="Suivi du cycle de vie et de la qualité de classement des documents"
        actions={
            ...
            {showFilters && (
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-4 border-t">
                ...
                <div>
                  ...
                  >
                    <option value="">Tous</option>
                    <option value="none">Orphelin</option>
                    <option value="property">Lié à un Bien</option>
