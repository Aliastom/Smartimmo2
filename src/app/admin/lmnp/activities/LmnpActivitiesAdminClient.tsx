...
export default function LmnpActivitiesAdminClient() {
    ...
    <div className="space-y-6 p-6 max-w-[1400px] mx-auto">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="text-2xl font-bold text-gray-900">Activités LMNP</h1>
          <p className="text-sm text-gray-600 mt-1">Gestion des activités LMNP/SIRET (création, édition, suppression sécurisée).</p>
        </div>
