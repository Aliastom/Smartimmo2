...
/**
 * GET /api/upload-staged/[id] - Récupérer un document brouillon
 */
...
/**
 * PATCH /api/upload-staged/[id] - Modifier un document brouillon
 */
...
/**
 * DELETE /api/upload-staged/[id] - Supprimer un document brouillon
 */
